...
const getCompilerUrl = (version: Version) => COMPILER_VERSIONS.find(s => s.version === version)

export const useCompiler = () => {
    const [workerInstances, setWorkerInstances] = useState(new Map<Version, any>());
    ...
    const compileJSON = async (version: Version, source: SourceWithTarget, options: CompilerOptions) => {
    ...
    const compile = (version: Version, files: Source, options: CompilerOptions, fileLoader: FileLoader): Promise<CompilationResult> => {
